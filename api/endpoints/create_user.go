...
func (h *handler) createUser(c *gin.Context, request *common.SignupRequest) (common.SignupResponse, error) {
	return common.SignupResponse{}, nil
}

func (h *handler) makeCreateUserRequest(c *gin.Context) (req *common.SignupRequest, err error) {
