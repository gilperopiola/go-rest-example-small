...
func (h *handler) changePassword(c *gin.Context, request *common.SignupRequest) (common.SignupResponse, error) {
	return common.SignupResponse{}, nil
}

func (h *handler) makeChangePasswordRequest(c *gin.Context) (req *common.SignupRequest, err error) {
