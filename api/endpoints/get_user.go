...
func (h *handler) getUser(c *gin.Context, request *common.SignupRequest) (common.SignupResponse, error) {
	return common.SignupResponse{}, nil
}

func (h *handler) makeGetUserRequest(c *gin.Context) (req *common.SignupRequest, err error) {
