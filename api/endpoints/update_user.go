...
func (h *handler) updateUser(c *gin.Context, request *common.SignupRequest) (common.SignupResponse, error) {
	return common.SignupResponse{}, nil
}

func (h *handler) makeUpdateUserRequest(c *gin.Context) (req *common.SignupRequest, err error) {
